...
<form> 
	...
	<table style="width: 100%;">
		...
		<tr>
			...
			%></td>
			<td style="text-align:left;">
				<a href="ControllerGiveBack?dvdId=<%= currentLoan.getDVDId() %>" onclick="return confirm('&Ecirc;tes-vous s&ucirc;r de vouloir rendre le DVD <%= currentLoan.getDVDTitle() %> ?')"><img alt="Rendre" title="Rendre le DVD <%= currentLoan.getDVDTitle() %>" border="0" /></a>
				<a href="view.jsp?action=details&dvdId=<%= currentLoan.getDVDId() %>"><img alt="D&eacute;tails" title="Afficher les d&eacute;tails du DVD <%= currentLoan.getDVDTitle() %>" border="0" /></a>
			</td>
		</tr>
				<% 
			}
